...
socials:
  ...
  tiktok: "@mainsquarefestival"
  threads: "@mainsquarefestival"
  x: "MainSquareFest"
  youtube: "@MainSquareFestival"
  web: "https://mainsquarefestival.fr/"
---

Chaque début juillet, la ville d'**Arras**, dans le Pas-de-Calais, devient pour trois jours la capitale française des
musiques actuelles. Dans le cadre majestueux de la **Citadelle Vauban**, le **Main Square Festival** réunit les plus
...
internationale, a vu défiler quelques-uns des plus grands noms de la planète musique : **Coldplay**, **Depeche Mode**,
...
**Orelsan**, **Marshmello** et **Twenty One Pilots** (pour un show exclusif en France), entourés de nombreux autres noms
...
actuelles de France. Trois jours, plusieurs scènes, 120 000 festivaliers et une affiche taillée pour faire chavirer le
nord de l'Europe chaque début juillet : le Main Square est un monument de l'été français.

{{< carousel pictures="pictures" alt="Main Square Festival" reverse="true" >}}
