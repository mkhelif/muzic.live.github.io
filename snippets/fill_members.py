...
# Optional exhaustive mapping, generated by export_instruments.py and editable
# by hand. Columns: instrument,type,role. Loaded lazily; keyword heuristics
# below remain the fallback for anything not listed.
INSTRUMENT_ROLES_CSV = Path(__file__).resolve().parent / "instrument_roles.csv"
VALID_ROLES = set(ROLE_ORDER)
_instrument_roles: dict[str, str] | None = None


def get_instrument_roles() -> dict[str, str]:
